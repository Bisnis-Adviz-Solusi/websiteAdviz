          ...
          >
            ...
            <div className="max-w-7xl mx-auto relative">
              ...
              <div className="text-center mb-20 feature-heading">
                ...
                <h2 className="text-3xl font-bold mb-4 mt-10 bg-gradient-to-r from-orange-400 via-orange-500 to-pink-400 bg-clip-text text-transparent">
                  {t("home.case.subtitle")}
                </h2>
              ...
              >
                <h3 className="text-2xl font-bold text-gray-700 dark:text-gray-200 mb-6 flex items-center">
                  ...
                  {t("home.case.sectionTitle")}
                </h3>

                <p className="text-lg text-gray-600 dark:text-gray-300 mb-8 leading-relaxed">
                  {t("home.case.sectionDesc")}
                </p>

                <p className="text-lg text-gray-600 dark:text-gray-300 mb-8 leading-relaxed">
                  {t("home.case.currentlySelling")}
                </p>
                  ...
                  {[
                    {
                      ...
                      icon: "📲",
                      name: t("home.case.brands.a.name"),
                      description: t("home.case.brands.a.desc"),
                      features: [
                        t("home.case.brands.a.features.0"),
                        t("home.case.brands.a.features.1"),
                        t("home.case.brands.a.features.2")
                      ]
                    },
                    {
                      color: "from-blue-500 to-indigo-600",
                      icon: "📲",
                      name: t("home.case.brands.b.name"),
                      description: t("home.case.brands.b.desc"),
                      features: [
                        t("home.case.brands.b.features.0"),
                        t("home.case.brands.b.features.1"),
                        t("home.case.brands.b.features.2")
                      ]
                    },
                    {
                      color: "from-indigo-500 to-orange-600",
                      icon: "📲",
                      name: t("home.case.brands.c.name"),
                      description: t("home.case.brands.c.desc"),
                      features: [
                        t("home.case.brands.c.features.0"),
                        t("home.case.brands.c.features.1"),
                        t("home.case.brands.c.features.2")
                      ]
                    }
